...
/**
 * Representation of a user of the ticketing app and all the functionality
 * available to users If invoked directly, this class will be used for guest
 * users
 * 
...
=======
	 ...
	 * information are put into a .txt file
	 */
	public void createReceipt() {
		try {
			PrintWriter receiptWriter = new PrintWriter(new File("receipt.txt"));
	 ...
	 * 
	 * @param event  name of the event the user is rating
	 * @param rating number from 1-10 which represents the user's rating of the
	 *               event
	 */
	public void rateEvent(String event, int rating) {
		ArrayList<Movie> movies = JsonParser.loadMovies();
	...
	/**
	 * Method which shows the user's current watchlist Prints out each event in the
	 * list
	 */
	public void displayWatchlist() {
		for (Show e : watchlist) {
	...
	/**
	 * Method which shows the user's current list of tickets Prints out information
	 * about each ticket in the list
	 */
	public void displayTickets() {
	...
	/**
	 * Method which allows the user to request a refund for any tickets in their
	 * list
	 * 
	 * @param event              name of the event the user is refunding tickets
	 *                           from
	 * @param numTicketsRefunded number of tickets to be refunded.
	 */
	public void requestRefund(String event, int numTicketsRefunded) {
	 ...
	 */
	public void removeFromWatchlist(String showName) {
>>>>>>> 9585dc16375b8ec3066dcf138e27cd8ce5190584
	...
	/**
	 * Standard setter for the user's rewards points Cannot be negative
	 * 
	...
	/**
	 * Standard setter for the user's account ID Cannot be negative
	 * 
	 ...
	 * 
	 * @param birthday the user's new birthday. Please don't make a mistake when
	 *                 entering your birthday the first time
	 */
